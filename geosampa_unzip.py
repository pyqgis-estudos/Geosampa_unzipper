...
class GeosampaUnzip:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GeosampaUnzip_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Geosampa Unzip')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GeosampaUnzip', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/geosampa_unzip/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'GeoSampa - Extrair ZIP'),
            callback=self.run,
